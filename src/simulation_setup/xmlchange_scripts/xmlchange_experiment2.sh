...
cd /cluster/work/users/evaler/noresm/FATES_INCLINE/cases/experiment2

./xmlchange CLM_USRDAT_NAME=ALP4
./xmlchange CLM_USRDAT_DIR=/cluster/shared/noresm/inputdata/evaler/inputdata/skj_pt_gswp3-otc2
...
./xmlchange JOB_WALLCLOCK_TIME=10:59:00
