...
# copy the default parameterfile (which has been modified before)
cd /cluster/home/evaler/CTSM/src/fates/parameter_files
cp fates_params_default.cdl fates_params_grazing.cdl

# change the cdl file to NetCDF
ncgen -o fates_params_grazing.nc fates_params_grazing.cdl

# modify parameters
cd /cluster/home/evaler/CTSM/src/fates/tools

./modify_fates_paramfile.py --input ../parameter_files/fates_params_grazing.nc \
--output ../parameter_files/fates_params_grazing.nc --overwrite \
...
cd /cluster/home/evaler/CTSM/src/fates/parameter_files
ncdump fates_params_grazing.nc > fates_params_grazing.cdl
